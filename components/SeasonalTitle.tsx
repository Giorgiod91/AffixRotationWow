...
export default function SeasonalCutoff() {
  ...
  // fetching data from https://raider.io/api/v1/mythic-plus/season-cutoffs?season=season-df-2&region=eu
  ...
  useEffect(() => {
    fetch("https://raider.io/api/v1/mythic-plus/season-cutoffs?season=season-df-2&region=eu")
      ...
      .then((data) => setSeasonalCutoff(data.p999.horde.quantileMinValue));
